...
Codex Computer Use for Firefox and Zen Browser is an independent compatibility port. The port does not add advertising, sell data, or add its own analytics service.
