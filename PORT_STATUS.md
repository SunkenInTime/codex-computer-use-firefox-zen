...
a universal macOS package supporting Intel and Apple Silicon, and a Linux x64
binary. The release workflow can Authenticode-sign the Windows installer and
Developer ID-sign, notarize, and staple the macOS package when the repository
